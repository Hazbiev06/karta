...
namespace Map
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            panel1.Visible = true;
            labeltop.Visible = true;
            labeltop.Text = "Chekpoint1";
            labeldrink.Text = "Вода";
